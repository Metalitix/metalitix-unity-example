...
namespace Metalitix.Scripts.Dashboard.Panels
{
    ...
    public class PreviewInteractableCanvas : PreviewInteractableUI
    {
        ...
        public override void SetMetalitixScene(MetalitixScene metalitixScene)
        {
            base.SetMetalitixScene(metalitixScene);
            timeLinePanel.SetMetalitixScene(MetalitixScene);
        }
    }
}